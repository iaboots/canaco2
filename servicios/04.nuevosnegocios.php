				...
				<div class="row">
					<div class="col-md-8">
						<div class="single-blog wow slideInLeft">
							<a href="#"><h3>Nuevos Negocios</h3></a>
							<img class="img-responsive img-rounded" 
							     src="../img/servicios/nuevos_negociosbbb.jpg" 
							     alt="Blog Image" />
					    
						    <h4>Objetivo:</h4>
						    <p>Asesoría y gestión en la tramitación y oportunidades de nuevos negocios.</p>
						    <br>
						    
						    <h4>¿Qué Ofrece?</h4>
						    <p>Brindar al público en general la asesoría referente a los trámites indispensables para iniciar un negocio comercial, de servicios o del sector turismo, además de asesoría a los socios cuando les falte algún trámite.</p>
						    <br>
						    
						    <h4>Procedimiento:</h4>
						    <p>Esta información se proporciona personalmente a quienes acuden directamente a CANACO; esto con el fin de que los interesados conozcan nuestra Cámara.</p>
						    
						    <p>Únicamente a los socios activos se brinda información por teléfono o correo electrónico.</p>
						    <br>

						    <h4>Ventajas:</h4>
						    <p>Ahorro de tiempo y dinero, información actual y confiable.</p>
