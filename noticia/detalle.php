						...
						<div class="container">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav navbar-right">
									...
									<li><a href="lista.php">Noticias</a></li>
			...
			<div class="container">
				<!-- listado de noticias -->			 
				 <?php
					 ...
					 $not = $controller->get_one_noticia($id_noti);
					 
					  ?>					 
						<div class="row">
							<div class="col-md-12">
								<div class="single-blog wow slideInLeft">
									<h4><?php echo $not['titulo'] ?></h4>
									...
									<div>
										<br>
									<div class="link-noti-foot">
									<a href="<?php echo $not['fuente']; ?>"
			 							target="_blank"
										class="ver-mas">Ver fuente</a>
									</div>
